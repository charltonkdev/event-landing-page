...
const About = () => {
  return (
    <div className='flex flex-col w-full h-auto relative px-24 py-12 gap-6 text-black bg-white overflow-hidden'>
        ...
        <TextParallax />
        <h3 className='absolute bottom-20 md:right-[5vw] right-[20vw] text-white md:p-6 text-right text-sm md:text-6xl md:max-w-6xl max-w-[50vw]'>
