...
const ArrowButton: FC<PropsWithChildren<{}>> = ({ children }) => {
  return (
    <button className='relative w-fit px-5 py-3 my-5 border rounded-full hover:bg-white hover:text-black duration-500 flex justify-center pl-14 hover:pl-5 hover:pr-14 group'>
